"""
Django settings for autoid project.
...
if not ON_HEROKU:
  ...
  assert "SECRET_KEY" in os.environ, ("please set environment variable " +
                                      "SECRET_KEY")
...
ROOT_URLCONF = 'autoid.urls'

TEMPLATES = [
  {
    'BACKEND': 'django.template.backends.django.DjangoTemplates',
    'DIRS':  [
        os.path.join(BASE_DIR, 'autoid', 'templates'),
    ],
    'APP_DIRS': True,
    'OPTIONS': {
      'context_processors': [
...
WSGI_APPLICATION = 'autoid.wsgi.application'
